...
<li>
    ...
    <div class="form-check">
        <div class="container mt-2 mb-2 d-flex justify-content-between" id="priceVal">
            <div class="row">
                <div class="col-5">
                    <input type="number" min="0" step="0.01" class="form-control pricepart" style="margin-left:-10px" id="pricepartstart" name="pricepartstart" value="<?= $data['pricepartstart'] ?>" form='submitFilterSearchSort' />
                </div>
                <div class="col-2">
                    <label class="form-control" style="margin-left:-9px; background:transparent; border:0px">-</label>
                </div>
                <div class="col-5">
                    <input type="number" min="0" step="0.01" class="form-control pricepart" style="margin-left:-10px" id="pricepartend" name="pricepartend" value='<?= $data['pricepartend'] ?>' form='submitFilterSearchSort' />
                </div>
            </div>
        </div>
    </div>
...
<a class="text-muted small fw-bold text-uppercase text-decoration-none sidebar-link" data-bs-toggle="collapse" role="button" data-bs-target="#manufacturersGroup" aria-controls="#manufacturersGroup" aria-expanded="<?= !empty($_POST['checkBoxVarManufacturers']) ? 'true' : 'false' ?>">Producenci
...
<li>
    <a class="text-muted small fw-bold text-uppercase text-decoration-none sidebar-link" data-bs-toggle="collapse" role="button" data-bs-target="#categGroup" aria-controls="#categGroup" aria-expanded="<?= !empty($_POST['checkBoxVarCategories']) ? 'true' : 'false' ?>">Kategorie
        <span class="bi bi-chevron-right right-icon ms-auto"></span>
    </a>
...
<li>
    <a class="text-muted small fw-bold text-uppercase text-decoration-none sidebar-link" data-bs-toggle="collapse" role="button" data-bs-target="#catGroup" aria-controls="#catGroup" aria-expanded="<?= !empty($_POST['checkBoxVarCatalogs']) ? 'true' : 'false' ?>">Katalogi
        <span class="bi bi-chevron-right right-icon ms-auto"></span>
    </a>
...
<li>
    <a class="text-muted small fw-bold text-uppercase text-decoration-none sidebar-link" data-bs-toggle="collapse" role="button" data-bs-target="#attrGroup" aria-controls="#attrGroup" aria-expanded="<?= !empty($_POST['checkBoxVarAttributes']) ? 'true' : 'false' ?>">Atrybuty
        <span class="bi bi-chevron-right right-icon ms-auto"></span>
    </a>
