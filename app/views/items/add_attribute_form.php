        ...
        <div class="row m-2">
            <div class="col-12 ">
                <div class="row m-2">
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="heightAttributeName" name="attributeName" 
                            placeholder="25" value='<?=$data['attributeName']?>' required maxlength="25">
                ...
                <div class="row m-2">
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="heightAttributeUnit" name="attributeUnit" 
                            placeholder="25" value='<?=$data['attributeUnit']?>' maxlength="25">
