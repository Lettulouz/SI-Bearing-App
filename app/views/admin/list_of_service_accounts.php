...
<h1 class="text-muted headers-padding">Lista obsługi sklepu</h1>
    ...
    <div class="col-12 col-md-6 col-lg-4">
        ...
        <?php } else {echo "Brak dodanej obsługi sklepu.";}?>
    </div>
...
<script>
    ...
    document.getElementById('sa_list').setAttribute( 'style', 'color:white !important' );
